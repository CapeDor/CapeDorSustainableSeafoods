...
class Services extends Component {
    state = {
        services : [
            { title : "Closed Containment", icon : "pe-7s-lock", description : "We make sure what comes in doesn't go out. Becaise we are a land-based facility has 0% risk of fish escaping to rivers and oceans." },
            ...
            { title : "Biosecure Seawater Wells", icon : "pe-7s-drop", description : "All of our water comes from the ocean and is naturally filtered undeground through 600 feet of gravel before being pumped into the facility." },
            ...
            { title : "Naturally Raised", icon : "pe-7s-leaf", description : "Our fish antibiotic, parasiticide, hormone, and GMO free. Our feed is organic and made with local fish meal with no avian or land animal byproducts" },
